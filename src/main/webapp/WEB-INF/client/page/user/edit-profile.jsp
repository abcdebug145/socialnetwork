        ...
        <form:form action="/profile/edit-profile" method="post" modelAttribute="account" enctype="multipart/form-data"
            ...
            <div class="d-flex container">
                <img class="rounded-circle"
                     id="avatarPicture" width="100" height="100" src="/images/avatar/${account.avatar}">
            ...
            <div class="container">
                <div class="mb-3">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <form:input type="text" class="form-control rounded-pill border-3 border" id="fullname"
                                        path="fullName"/>
                        </div>
                    </div>
                    <div class="mb-3">
                        ...
                        <div class="row">
                            ...
                            <textarea id="about" placeholder="Tell us about yourself"
                                      ...
                                      style="resize:none">${account.about}</textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <form:input type="text" class="form-control rounded-pill border-3 border" id="username"
                                            path="username"/>
                            </div>
                        </div>
                    </div>
                    <div class="mb-3">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <form:input type="text" class="form-control rounded-pill border-3 border" id="Address"
                                            path="address"/>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-5">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <input type="email" class="form-control rounded-pill border-3 border disabled"
                                       id="email" value="<%= session.getAttribute("username")%>" disabled/>
                            </div>
                        </div>
...
<div class="container fixed-bottom text-black d-flex bg-white justify-content-center border-top text-black">
    <div class="my-2">
        <button id="reset-button" class="btn rounded-pill fs-5 fw-normal text-black" type="button" disabled
                style="background-color:#e9e9e9" onclick="window.location.reload()">
            Reset
        </button>
