...
<div class="container-fluid mb-3 d-flex flex-column justify-content-center align-items-center">
    <img src="/images/avatar/${account.avatar}" class="rounded-circle mb-3 p-2" width="150" height="150">
    ...
    <c:choose>
        <c:when test="${account.email==sessionScope.username}">
            ...
            <a href="/profile/edit-profile" class="btn btn-secondary rounded-pill mb-3 fs-5">Edit Profile</a>
        </c:when>
    </c:choose>
