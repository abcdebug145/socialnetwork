        ...
        <div class="container col-sm-6 position-relative">
            ...
            <c:forEach items="${comments}" var="comment">
                <div class="d-lex justify-content-between">
                    <img height="30" width="30" alt="avatar"
                         src="/images/avatar/${comment.account.avatar}"/>
                    <p><strong>${comment.account.username}:</strong> ${comment.content}
                    </p>
            ...
            <div class="position-absolute bottom-0 pb-5 col-12">
                ...
                <div class="form-group">
                        <textarea type="text" class="form-control" name="comment" id="${post.id}"
                                  rows="3"
